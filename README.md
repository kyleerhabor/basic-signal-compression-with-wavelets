...
A program that applies the 1D discrete Haar transform to a numeric signal, zeroing-out all detail coeﬃcients below a certain threshold and applying the inverse transform to demonstrate basic data compression.
